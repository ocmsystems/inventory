...
class ProductListController extends Controller {
	...
	public function index(Request $request)
    {
		...
		return view('Inventory.Products.ProductList.index', compact('productlist'));
	}
	...
	public function create()
	{
	    ...
	    return view('Inventory.Products.ProductList.create', compact("productcategories"));
	}
	...
	public function edit($id)
	{
		...
		return view('Inventory.Products.ProductList.edit', compact('productlist', "productcategories"));
	}
