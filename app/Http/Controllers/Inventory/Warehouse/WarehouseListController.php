...
class WarehouseListController extends Controller {
	...
	public function index(Request $request)
    {
		...
		return view('Inventory.Warehouse.WarehouseList.index', compact('warehouselist'));
	}
	...
	public function create()
	{
	    ...
	    return view('Inventory.Warehouse.WarehouseList.create', compact('type'));
	}
	...
	public function edit($id)
	{
		...
		return view('Inventory.Warehouse.WarehouseList.edit', compact('warehouselist', 'type'));
	}
