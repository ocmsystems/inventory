...
class ProductCategoriesController extends Controller {
	...
	public function index(Request $request)
    {
		...
		return view('Setup.Products.ProductCategories.index', compact('productcategories'));
	}
	...
	public function create()
	{
	    ...
	    return view('Setup.Products.ProductCategories.create');
	}
	...
	public function edit($id)
	{
		...
		return view('Setup.Products.ProductCategories.edit', compact('productcategories'));
	}
