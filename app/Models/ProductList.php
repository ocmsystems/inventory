...
class ProductList extends Model {
    ...
    */
    ...
    {
        return $this->hasOne('App\Models\ProductCategories', 'id', 'productcategories_id');
    }
    ...
    public function search($params){
        ...
        $query = $this->selectRaw('productlist.name, CONCAT(productlist.name) as text, productlist.id, productlist.description, productlist.sku, productlist.price')
