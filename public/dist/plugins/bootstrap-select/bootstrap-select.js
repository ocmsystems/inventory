(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      '<label for="' + this.$element[0].name + '_select_' + 'search">Search</label>' + 
      '<input type="text" autocomplete="off"' +
      (null === this.options.liveSearchPlaceholder ? '' : ' placeholder="' + htmlEscape(this.options.liveSearchPlaceholder) + '"') + ' role="textbox" aria-label="Search" id="' + this.$element[0].name + '_select_' + 'search" style="margin: 0;">' +
      '</div>' +
      '</div>'
          : '';
      ...
      var drop =
          ...
          '<button type="button" class="no-autoinit ' + this.options.styleBase + ' dropdown-toggle" ' + (this.options.display === 'static' ? 'data-display="static"' : '') + 'data-toggle="dropdown"' + autofocus + ' role="button">' +
    ...
    liHeight: function (refresh) {
      ...
      if (search) {
        ...
        search.className = 'bs-searchbox md-form';
