...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFileIcon = '<i class="fas fas-file"></i>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: true,
                    showDrag: true,
                    removeIcon: '<i class="fas fas-trash"></i>',
                    removeClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    removeErrorClass: 'btn btn-sm btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="fas fas-upload"></i>',
                    uploadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="fas fas-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="fas fas-download"></i>',
                    downloadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="fas fas-zoom-in"></i>',
                    zoomClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
                    zoomTitle: 'View Details',
                    dragIcon: '<i class="fas fas-move"></i>',
                    dragClass: 'text-info',
                    dragTitle: 'Move / Rearrange',
                    dragSettings: {},
                    indicatorNew: '<i class="fas fas-plus-sign text-warning"></i>',
                    indicatorSuccess: '<i class="fas fas-ok-sign text-success"></i>',
                    indicatorError: '<i class="fas fas-exclamation-sign text-danger"></i>',
                    indicatorLoading: '<i class="fas fas-hourglass text-muted"></i>',
                    indicatorPaused: '<i class="fas fas-pause text-primary"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="fas fas-triangle-left"></i>',
            next: '<i class="fas fas-triangle-right"></i>',
            toggleheader: '<i class="fas fas-resize-vertical"></i>',
            fullscreen: '<i class="fas fas-fullscreen"></i>',
            borderless: '<i class="fas fas-resize-full"></i>',
        ...
        customLayoutTags: {},
        customPreviewTags: {},
        previewFileIcon: '<i class="fas fas-file"></i>',
        previewFileIconClass: 'file-other-icon',
        previewFileIconSettings: {},
        previewFileExtSettings: {},
        buttonLabelClass: 'hidden-xs',
        browseIcon: '<i class="fas fas-folder-open"></i>&nbsp;',
        browseClass: 'btn btn-primary',
        removeIcon: '<i class="fas fas-trash"></i>',
        removeClass: 'btn btn-default btn-secondary',
        cancelIcon: '<i class="fas fas-ban-circle"></i>',
        cancelClass: 'btn btn-default btn-secondary',
        pauseIcon: '<i class="fas fas-pause"></i>',
        ...
        msgValidationErrorIcon: '<i class="fas fas-exclamation-sign"></i> ',
