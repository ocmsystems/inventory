...
{!! Form::open(array('route' => config('quickadmin.route').'.inventoryadjustments.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="header-title">
    ...
    <div class="float-left">
        <h3 class="mt-2 ml-3"> {!! link_to_route(config('quickadmin.route').'.inventoryadjustments.index', 'Inventory Adjustments' , null) !!} / New</h3>
        ...
        <div class="row">
            <div class="col-sm-10 col-lg-2">
                <div class="input-field">
                    ...
                    {!! Form::select('type', [1 => 'Current', 2 => 'Beginning'], old('warehouse_id'), array('class'=>'form-control selectpicker', 'title' => 'Choose quantity type..')) !!}
