...
{!! Form::open( array('route' => config('quickadmin.route').'.pullouts.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="header-title">
    ...
    <div class="float-left">
        <h3 class="mt-2 ml-3"> {!! link_to_route(config('quickadmin.route').'.pullouts.index', 'Pull Out' , null) !!} / New</h3>
            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-lg-2 offset-lg-2">
                    <div class="input-field">
                        ...
                        {!! Form::text('datetime_prepared', old('datetime_prepared', date("M d, Y")), array('class'=>'form-control datetimepicker', 'readonly')) !!}
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-lg-4">
                    <div class="input-field">
                        ...
                        {!! Form::select('warehouse_id', $warehouselist, old('warehouse_id'), array('class'=>'form-control selectpicker no-autoinit', 'title' => 'Choose location..', 'data-live-search' => 'true')) !!}
                    </div>
                </div>
                ...
                <div class="col-sm-10 col-lg-2 offset-lg-1">
                    <div class="input-field">
                        ...
                        {!! Form::text('pullout_date', old('pullout_date', date("M d, Y")), array('class'=>'form-control datetimepicker')) !!}
                    </div>
                </div>
            </div>
