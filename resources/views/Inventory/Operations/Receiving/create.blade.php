...
{!! Form::open(array('route' => config('quickadmin.route').'.receiving.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="header-title">
    ...
    <div class="float-left">
        <h3 class="mt-2 ml-3"> {!! link_to_route(config('quickadmin.route').'.receiving.index', 'Receiving' , null) !!} / New</h3>
    ...
    <div class="card-header no-border">
        ...
        <div class="row">
            ...
            <div class="col-sm-10 col-lg-3">
                ...
                <div class="input-field mt-3">
                    {!! Form::select('delivery_id', [], old('delivery_id'), array('class'=>'form-control pt-0 mb-0', 'id' => 'delivery_id')) !!}
                    {!! Form::hidden('source_document', old('source_document'), array('class'=>'form-control')) !!}
                </div>
            </div>
            ...
            <div class="col-sm-10 col-lg-3 offset-lg-2">
                <div class="input-field">
                    ...
                    {!! Form::text('received_date', old('received_date', date("M d, Y") ), array('class'=>'form-control datepicker')) !!}
        ...
        <div class="row">
            ...
            <div class="col-sm-10 col-lg-4">
                ...
                {!! Form::select('receiving_warehouse', $warehouselist, old('receiving_warehouse'), array('class'=>'form-control selectpicker', 'disabled', 'title' => ' ', 'data-live-search' => 'true')) !!}
                {!! Form::hidden('receiving_warehouse_id', old('receiving_warehouse_id'), array('class'=>'form-control', 'id' => 'receiving_warehouse_id')) !!}
            </div>
            ...
            <div class="col-sm-10 col-lg-3 offset-lg-1">
                <div class="input-field">
                    ...
                    {!! Form::text('delivery_date', old('delivery_date'), array('class'=>'form-control', 'readonly', 'id' => 'delivery_date')) !!}
        ...
        <div class="row">
            ...
            <div class="col-sm-10 col-lg-4">
                <div class="input-field">
                    ...
                    {!! Form::select('source_warehouse', $warehouselist, old('source_warehouse'), array('class'=>'form-control selectpicker', 'title' => ' ', 'disabled', 'data-live-search' => 'true')) !!}
                    {!! Form::hidden('source_warehouse_id', old('source_warehouse_id'), array('class'=>'form-control', 'id' => 'source_warehouse_id')) !!}
        ...
        <div class="row">
            <div class="col-sm-10 col-lg-8">
                ...
                <div class="input-field">
                    ...
                    {!! Form::textarea('notes', old('notes'), array('class'=>'materialize-textarea form-control', 'rows' => '2', 'style'=>'padding-top: 5px')) !!}
                </div>
