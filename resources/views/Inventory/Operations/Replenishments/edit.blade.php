...
<div class="header-title">
    ...
    <div class="float-left">
        <h3 class="mt-2 ml-3"> {!! link_to_route(config('quickadmin.route').'.replenishments.index', 'Replenishments' , null) !!} / {{$replenishments->transaction_number}}</h3>
            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-lg-3">
                    <div class="input-field">
                        ...
                        {!! Form::text('contact_person', old('contact_person', $replenishments->contact_person), array('class'=>'form-control')) !!}
                    </div>
                </div>
                ...
                <div class="col-sm-10 col-lg-2 offset-lg-2">
                    <div class="input-field">
                        ...
                        {!! Form::text('scheduled_date', old('scheduled_date', date("F d, Y", strtotime($replenishments->scheduled_date)) ), array('class'=>'form-control datetimepicker')) !!}
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-lg-4">
                    <div class="input-field">
                        ...
                        {!! Form::select('destination_warehouse_id', $warehouselist, old('destination_warehouse_id', $replenishments->destination_warehouse_id), array('class'=>'form-control selectpicker', 'title' => 'Choose location..', 'data-live-search' => 'true')) !!}
                    </div>
                </div>
                ...
                <div class="col-sm-10 col-lg-2 offset-lg-1">
                    <div class="input-field">
                        ...
                        {!! Form::text('source_document', old('source_document', $replenishments->source_document), array('class'=>'form-control')) !!}
                    </div>
                </div>
                        ...
                        <div class="tab-pane" id="notes-attr" role="tabpanel" aria-labelledby="notes-tab-attr">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-lg-8">
                                    <div class="input-field">
                                        {!! Form::textarea('notes', old('notes', $replenishments->notes), array('class'=>'materialize-textarea form-control', 'rows' => '2', 'style'=>'padding-top: 0px', 'id'=>'notes')) !!}
                                    </div>
                                </div>
                            </div>
