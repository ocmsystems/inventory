...
{!! Form::open( array('route' => config('quickadmin.route').'.returns.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="header-title">
    ...
    <div class="float-left">
        <h3 class="mt-2 ml-3"> {!! link_to_route(config('quickadmin.route').'.returns.index', 'Returns' , null) !!} / New</h3>
        ...
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-lg-4">
                    <div class="input-field">
                        {!! Form::label('destination_warehouse_id', 'Store Location*', array('class'=>'active')) !!}
