...
{!! Form::open(array('route' => config('quickadmin.route').'.businessunit.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="header-title">
    ...
    <div class="float-left">
        <h3 class="mt-2 ml-3"> {!! link_to_route(config('quickadmin.route').'.businessunit.index', 'Business Unit' , null) !!} / New</h3>
