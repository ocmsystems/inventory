...
class ViewsBuilder
{
    ...
    public function build($parent_id)
    {
        ...
        if(!empty($menu)){
            ...
            $this->parentDir = ucfirst(Str::camel($menu->name)) . DIRECTORY_SEPARATOR;
        }
    ...
    private function publishCustom($template){
        ...
        if (! file_exists(base_path('resources' . DIRECTORY_SEPARATOR . 'views' . DIRECTORY_SEPARATOR . $this->grandParentDir . $this->parentDir . $this->name))) {
            mkdir(base_path('resources' . DIRECTORY_SEPARATOR . 'views' . DIRECTORY_SEPARATOR . $this->grandParentDir . $this->parentDir . $this->name));
            chmod(base_path('resources' . DIRECTORY_SEPARATOR . 'views' . DIRECTORY_SEPARATOR . $this->grandParentDir . $this->parentDir . $this->name), 0775);
        }
        file_put_contents(base_path('resources' . DIRECTORY_SEPARATOR . 'views' . DIRECTORY_SEPARATOR . $this->grandParentDir . $this->parentDir . $this->name . DIRECTORY_SEPARATOR . 'index.blade.php'),
            $template[0]);
    }
